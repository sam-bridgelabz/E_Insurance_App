...
class AdminQueries:
    ...
    @staticmethod
    def check_if_email_is_same(db: Session, updated_email: str, admin_id: str) -> Admin | None:
        return db.query(Admin).filter(Admin.email == updated_email, Admin.id != admin_id)
...
class EmployeeQueries:
    ...
    @staticmethod
    def check_if_email_is_same(db: Session, updated_email: str, employee_id: str) -> Employee | None:
        return db.query(Employee).filter(Employee.email == updated_email, Employee.id != employee_id)
