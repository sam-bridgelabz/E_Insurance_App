...
Revision ID: f9f551e27ea6
Revises: 
Create Date: 2025-06-23 13:00:01.856774
...
def upgrade() -> None:
    ...
    sa.Column('email', sa.String(length=100), nullable=False),
    sa.Column('password', sa.String(length=100), nullable=False),
    sa.Column('dept', sa.Enum('OPERATIONS', 'HR', 'FINANCE', 'TECH', name='departmentenum',native_enum=False), nullable=False),
    ...
    sa.Column('type', sa.Enum('purchase', 'renewal', name='transactiontype'), nullable=False),
